...
const values = [
{
  ...
  description: 'Every transaction is conducted with full transparency. We represent your interests exclusively — no dual agency, no hidden incentives.'
},
{
  icon: 'StarIcon',
  title: 'Curated Excellence',
  description: 'We list only properties that meet our exacting standards. Quality over volume — always. Our portfolio reflects the finest the market offers.'
},
{
  icon: 'GlobeAltIcon',
  title: 'Global Perspective',
  description: 'With clients across 40+ countries, we bring international market intelligence to every local transaction and global reach to every listing.'
},
{
  icon: 'UserGroupIcon',
  title: 'Relationship First',
  description: 'We build lifelong client relationships, not one-time transactions. Your portfolio growth and satisfaction are our long-term measure of success.'
}];
...
},
{
  ...
  bio: 'Sophia has facilitated over AED 2.4 billion in residential transactions. Her deep knowledge of Palm Jumeirah and Downtown Dubai is unmatched in the market.',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_1e95358c6-1772081363912.png",
  alt: 'Professional portrait of Sophia Harrington, Head of Residential Sales, in a professional setting with natural light',
  linkedin: '#'
},
{
  name: 'Marcus Al-Rashid',
  role: 'Director of International Projects',
  bio: 'Marcus leads our international portfolio division, sourcing and presenting off-plan opportunities across Europe, Asia, and the Americas to UAE-based investors.',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_1a79b8e72-1763295320816.png",
  alt: 'Professional portrait of Marcus Al-Rashid, Director of International Projects, in a modern office environment',
  linkedin: '#'
},
{
  name: 'Isabelle Fontaine',
  role: 'Head of Commercial & Investment',
  bio: 'A former investment banker turned real estate specialist, Isabelle structures complex commercial acquisitions and investment portfolios for institutional and UHNW clients.',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_1da2046d3-1763298640049.png",
  alt: 'Professional portrait of Isabelle Fontaine, Head of Commercial and Investment, in a sophisticated business setting',
  linkedin: '#'
}];
    ...
    <main className="bg-background overflow-x-hidden">
      ...
      <section className="relative min-h-[75vh] flex flex-col justify-end overflow-hidden">
        <div className="absolute inset-0 z-0">
          <AppImage
            src="https://images.unsplash.com/photo-1571907761804-27e376886f3d"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 w-full pb-16 pt-40">
          <div ref={heroRef} className="flex flex-col gap-6">
            ...
            <h1 className="text-hero text-foreground max-w-3xl">
              Built on Trust,{' '}
              <span className="text-gold-shimmer">Defined by Excellence</span>
            </h1>
            <p className="text-foreground/70 text-base md:text-lg max-w-lg leading-relaxed">
              Since 2006, Cove Estates has been the trusted partner for discerning clients seeking the finest properties in Dubai and beyond.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-on-scroll">
              <span className="text-xs font-bold uppercase tracking-[0.3em] text-primary mb-4 block">Who We Are</span>
              <h2 className="text-3xl md:text-5xl font-bold text-foreground tracking-tighter leading-none mb-8">
                Dubai's Premier<br />
                <span className="text-gold-shimmer">Luxury Advisory</span>
              </h2>
              <div className="space-y-5 text-muted-foreground text-sm leading-relaxed">
                <p>
                  Cove Estates was founded on a singular conviction: that luxury real estate deserves a fundamentally different approach. Not a transactional one, but an advisory one — where client outcomes are the only measure of success.
                </p>
                <p>
                  From our offices in Dubai Marina and DIFC, we serve a global clientele of private investors, family offices, and ultra-high-net-worth individuals seeking the finest residential and commercial properties in the UAE and internationally.
                </p>
                <p>
                  Our team of 24 specialists brings together expertise across residential sales, commercial investment, off-plan acquisitions, and international markets — offering clients a single, trusted point of contact for their entire real estate portfolio.
                </p>
              </div>
            </div>
      ...
      <section ref={valuesRef} className="py-20 px-6 md:px-10 border-t border-border bg-card">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6 animate-on-scroll">
            <div>
              <span className="text-xs font-bold uppercase tracking-[0.3em] text-primary mb-3 block">What Guides Us</span>
            ...
            <p className="text-muted-foreground text-sm max-w-xs leading-relaxed text-right">
              The principles that shape every client interaction, every listing, and every transaction we undertake.
            </p>
          </div>
