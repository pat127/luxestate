        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="animate-on-scroll">
            ...
            <p className="text-muted-foreground text-base leading-relaxed mb-12 max-w-md">
              Every exceptional acquisition begins with a conversation. Share your vision, and our principals will personally respond within 24 hours.
            </p>
            ...
            <div className="mt-12 border border-border p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-xs font-bold uppercase tracking-widest text-primary">Currently Accepting New Clients</span>
              </div>
              <p className="text-muted-foreground text-xs leading-relaxed">
                We work with a limited number of clients per quarter to ensure every acquisition receives our full attention and expertise.
              </p>
            </div>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Tell us about your ideal property — location, architecture, lifestyle requirements..."
                  />
                </div>
                <button
                  type="submit"
