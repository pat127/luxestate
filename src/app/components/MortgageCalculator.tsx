      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8 animate-on-scroll">
          ...
          <p className="text-muted-foreground text-sm max-w-xs leading-relaxed">
            Estimate your monthly payments and understand the full financial picture before you commit.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 animate-on-scroll">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[10, 15, 20, 25, 30].map((term) => (
                  <button
                    ...
                    className={`py-3 text-sm font-bold border transition-all duration-300 ${
                      loanTerm === term
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-primary p-8 md:p-10 flex flex-col justify-between flex-1">
              <div>
                <p className="text-primary-foreground/70 text-xs font-bold uppercase tracking-[0.2em] mb-3">
                  Estimated Monthly Payment
                </p>
                <p className="text-4xl md:text-5xl font-black text-primary-foreground tracking-tighter leading-none">
                  {fmt(monthly)}
                </p>
