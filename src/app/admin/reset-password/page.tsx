        ...
        <div className="bg-card border border-border p-8">
          ...
          {success ? (
            <div className="space-y-4">
              <div className="flex items-start gap-3 px-4 py-3 bg-emerald-500/10 border border-emerald-500/20">
                <Icon name="CheckCircleIcon" size={16} className="text-emerald-400 flex-shrink-0 mt-0.5" />
            ...
            <form onSubmit={handleReset} className="space-y-4">
              ...
              {!sessionReady && (
                <p className="text-[10px] text-muted-foreground text-center">
                  Waiting for session... Make sure you opened this link from the reset email.
                </p>
              )}
            </form>
          )}
