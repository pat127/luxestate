...
export default function PropertiesPage() {
  ...
  const handleEditProperty = (property: Property) => {
    ...
    setFormData({
      ...
      propertyType: p.propertyType || (p.type === 'Commercial' ? 'Office' : 'Apartment'),
      listingType: p.listingType || 'For Sale',
      priceAED: p.price ? p.price.replace('AED ', '').replace(/,/g, '') : '',
      pricePerSqFt: p.pricePerSqFt || '',
      serviceCharge: p.serviceCharge || '',
      bedrooms: p.bedrooms || (p.beds != null ? String(p.beds) : ''),
      bathrooms: p.bathrooms || (p.baths != null ? String(p.baths) : ''),
      areaSqFt: p.areaSqFt || p.sqft || '',
      builtUpArea: p.builtUpArea || '',
      plotArea: p.plotArea || '',
      buaVilla: p.buaVilla || '',
      plotAreaVilla: p.plotAreaVilla || '',
      gfa: p.gfa || '',
      plotAreaLand: p.plotAreaLand || '',
      landUse: p.landUse || '',
      heightLimit: p.heightLimit || '',
      furnishing: p.furnishing || '',
      view: p.view || '',
      balcony: p.balcony || false,
      maidRoom: p.maidRoom || false,
      studyRoom: p.studyRoom || false,
      privatePool: p.privatePool || false,
      privateGarden: p.privateGarden || false,
      ...
      imageUrls: p.imageUrls || (p.image ? p.image : ''),
      videoUrl: p.videoUrl || '',
    ...
    if (editingProperty) {
      const updated = propertyList.map((p) =>
        p.id === editingProperty.id ?
        {
          ...
          buaVilla: formData.buaVilla,
          plotAreaVilla: formData.plotAreaVilla,
          gfa: formData.gfa,
          plotAreaLand: formData.plotAreaLand,
          landUse: formData.landUse,
          heightLimit: formData.heightLimit,
          furnishing: formData.furnishing,
          view: formData.view,
          balcony: formData.balcony,
          maidRoom: formData.maidRoom,
      ...
      const newProp: Property = {
        ...
        ...(formData.listingType && { listingType: formData.listingType }),
        ...(formData.pricePerSqFt && { pricePerSqFt: formData.pricePerSqFt }),
        ...(formData.serviceCharge && { serviceCharge: formData.serviceCharge }),
        ...(formData.completion && { completion: formData.completion }),
        ...(formData.bedrooms && { bedrooms: formData.bedrooms }),
        ...(formData.bathrooms && { bathrooms: formData.bathrooms }),
        ...(formData.areaSqFt && { areaSqFt: formData.areaSqFt }),
        ...(formData.builtUpArea && { builtUpArea: formData.builtUpArea }),
        ...
        privatePool: formData.privatePool,
        privateGarden: formData.privateGarden,
        ...(formData.amenities && { amenities: formData.amenities }),
        ...(formData.emirate && { emirate: formData.emirate }),
        ...(formData.locationArea && { locationArea: formData.locationArea }),
        ...(formData.community && { community: formData.community }),
        ...(formData.fullAddress && { fullAddress: formData.fullAddress }),
        ...
        ...(formData.virtualTourUrl && { virtualTourUrl: formData.virtualTourUrl }),
      } as any;
