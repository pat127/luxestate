...
function loadProjects(): Project[] {
  ...
  try {
    ...
    const hasBeenInitialized = localStorage.getItem('admin_projects_initialized');
    let base: Project[] = stored ? JSON.parse(stored) : (hasBeenInitialized ? [] : []);
    if (!hasBeenInitialized && !stored) {
      localStorage.setItem('admin_projects_initialized', '1');
    }
